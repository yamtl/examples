...
import issueTracking.IssueTrackingFactory;
 ...
 * @generated
 */
public class IssueTrackingPackageImpl extends EPackageImpl implements IssueTrackingPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see issueTracking.IssueTrackingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IssueTrackingPackageImpl() {
		super(eNS_URI, IssueTrackingFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link IssueTrackingPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IssueTrackingPackage init() {
		if (isInited) return (IssueTrackingPackage)EPackage.Registry.INSTANCE.getEPackage(IssueTrackingPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredIssueTrackingPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		IssueTrackingPackageImpl theIssueTrackingPackage = registeredIssueTrackingPackage instanceof IssueTrackingPackageImpl ? (IssueTrackingPackageImpl)registeredIssueTrackingPackage : new IssueTrackingPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theIssueTrackingPackage.createPackageContents();

		// Initialize created meta-data
		theIssueTrackingPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theIssueTrackingPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IssueTrackingPackage.eNS_URI, theIssueTrackingPackage);
		return theIssueTrackingPackage;
	}
	 ...
	 */
	@Override
	public EReference getIssueTracker_Users() {
		return (EReference)issueTrackerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getUser_ReportedIssues() {
	 ...
	 */
	@Override
	public EReference getUser_AssignedIssues() {
	 ...
	 */
	@Override
	public IssueTrackingFactory getIssueTrackingFactory() {
		return (IssueTrackingFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(issueTrackerEClass, ISSUE_TRACKER__USERS);
		...
		createEReference(userEClass, USER__REPORTED_ISSUES);
		createEReference(userEClass, USER__ASSIGNED_ISSUES);
	...
	public void initializePackageContents() {
		...
		initEReference(getIssueTracker_Users(), this.getUser(), null, "users", null, 0, -1, IssueTracker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUser_ReportedIssues(), this.getIssue(), this.getIssue_ReportedBy(), "reportedIssues", null, 0, -1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUser_AssignedIssues(), this.getIssue(), this.getIssue_AssignedTo(), "assignedIssues", null, 0, -1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(issueEClass, Issue.class, "Issue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIssue_ID(), ecorePackage.getEString(), "ID", null, 0, 1, Issue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIssue_Priority(), ecorePackage.getEString(), "priority", null, 0, 1, Issue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_Status(), this.getStatus(), "status", null, 0, 1, Issue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIssue_ReportedBy(), this.getUser(), this.getUser_ReportedIssues(), "reportedBy", null, 1, 1, Issue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIssue_AssignedTo(), this.getUser(), this.getUser_AssignedIssues(), "assignedTo", null, 0, -1, Issue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getComment_CommentID(), ecorePackage.getEString(), "CommentID", null, 0, 1, Comment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getComment_Timestamp(), ecorePackage.getEDate(), "Timestamp", null, 0, 1, Comment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComment_Issue(), this.getIssue(), this.getIssue_Comments(), "issue", null, 1, 1, Comment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
