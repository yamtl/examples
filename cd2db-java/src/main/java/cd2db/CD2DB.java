...
public class CD2DB extends YAMTLModule {
    ...
    public static void main(String[] args) {
        ...
        xform.saveOutputModels(Map.of("db", "src/main/java/cd2db/out/out_after_batch.xmi"), List.of("Table", "Type"));
        ...
        xform.saveOutputModels(Map.of("db", "src/main/java/cd2db/out/out_after_prop.xmi"), List.of("Table", "Type"));
    }
