...
class HelperTest extends YAMTLModule {
	...
	def void testHelper() {
		...
		def mmF = YAMTLModule.loadMetamodel(BASE_PATH + '/flowchart.ecore') as EPackage
		def mmH = YAMTLModule.loadMetamodel(BASE_PATH + '/html.ecore') as EPackage
		def xform = new Helper(mmF, mmH)
