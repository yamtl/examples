...
import flowchartToHtmlExamples.Inheritance
import yamtl.core.YAMTLModule
import yamtl.groovy.YAMTLGroovyExtensions
import yamtl.utils.EMFComparator

class InheritanceTest extends YAMTLModule {
    ...
    def void testInheritance() {		
		...
		def xform = new Inheritance(srcRes.contents[0], tgtRes.contents[0])
		xform.loadInputModels(['in': BASE_PATH + '/wakeup_with_subflow.xmi'])
		xform.execute()
		xform.saveOutputModels(['out': BASE_PATH + '/inheritanceOutput.xmi'])
		...
		def expectedResource = xform.loadModel(BASE_PATH + '/inheritanceExpectedOutput.xmi', false)
